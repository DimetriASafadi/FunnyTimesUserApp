...
class SFilterSubCategoryAdapter (val context: Context, var data: ArrayList<FTFilterSubCategory>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.SortName.text = data[position].SubCatName


        return view
    }

    override fun getItem(position: Int): FTFilterSubCategory? {
