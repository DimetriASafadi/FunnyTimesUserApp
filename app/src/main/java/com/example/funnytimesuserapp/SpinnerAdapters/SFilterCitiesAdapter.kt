...
class SFilterCitiesAdapter (val context: Context, var data: ArrayList<FTFilterCity>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.SortName.text = data[position].CityName


        return view
    }

    override fun getItem(position: Int): FTFilterCity? {
