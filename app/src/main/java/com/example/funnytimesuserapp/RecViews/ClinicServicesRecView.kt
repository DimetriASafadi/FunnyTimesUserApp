...
class ClinicServicesRecView(val data : ArrayList<FTClinicService>, val context: Context,val onClinicServiceClick: OnClinicServiceClick) : RecyclerView.Adapter<serviceViewHolder>() {
    ...
    override fun onBindViewHolder(holder: serviceViewHolder, position: Int) {
        ...
        onClinicServiceClick.OnClinicServiceClickListener(getFinalPrice())
        holder.WholeService.setOnClickListener {
            data[position].ServiceIsSelected = !data[position].ServiceIsSelected
