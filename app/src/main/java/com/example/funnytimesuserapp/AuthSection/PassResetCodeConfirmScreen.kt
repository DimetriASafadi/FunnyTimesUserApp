...
import com.example.funnytimesuserapp.databinding.FtPassResetCodeConfirmScreenBinding
import org.json.JSONException
import org.json.JSONObject
import java.nio.charset.Charset

class PassResetCodeConfirmScreen : AppCompatActivity() {

    lateinit var binding: FtPassResetCodeConfirmScreenBinding
    val commonFuncs = CommonFuncs()
    var phonenum = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FtPassResetCodeConfirmScreenBinding.inflate(layoutInflater)
    ...
    fun checkCode_Request(phonenum:String,code:String) {
        ...
        val url = Constants.APIMain + "api/auth/checkCode"
        try {
